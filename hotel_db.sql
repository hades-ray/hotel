...
(1, 'Стандарт 101', 2000.00, 'active', 'Уютный номер с видом на тихий дворик, идеально подходит для отдыха.', 2, 'https://images.unsplash.com/photo-1611892440504-42a792e24d32?w=800'),
(2, 'Люкс 201', 10000.00, 'active', 'Роскошный люкс с панорамными окнами на центр города и большой ванной.', 2, 'https://images.unsplash.com/photo-1590490360182-c33d57733427?w=800'),
