...
(1, 'hadesray', 1, '2026-04-15', '2026-04-20', 'Отменено', 1, 17500.00),
(2, 'ben', 2, '2026-04-14', '2026-04-16', 'Отменено', 3, 14400.00),
(3, 'hadesray', 1, '2026-04-27', '2026-04-29', 'Отменено', 1, 7000.00),
(4, 'hadesray', 2, '2026-04-18', '2026-04-21', 'Отменено', 1, 21600.00),
(5, 'hadesray', 1, '2026-04-21', '2026-04-24', 'Отменено', 1, 10500.00),
(6, 'hadesray', 1, '2026-04-15', '2026-04-18', 'Отменено', 1, 10500.00);
...
(1, 'Стандарт 101', 5000.00, 'active', 'Уютный номер с видом на тихий дворик, идеально подходит для отдыха.', 2, 'std.jpg'),
...
(1, 'hadesray', 'hadesray@yandex.ru', '1234', 'user', '2026-04-14 01:07:39'),
(2, 'admin', 'admin@hotel.com', 'Qaz12345', 'admin', '2026-04-14 01:11:48'),
(3, 'ben', '123@asd.ru', '1234', 'user', '2026-04-14 02:21:58');
